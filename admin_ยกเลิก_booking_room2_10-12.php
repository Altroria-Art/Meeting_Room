...
<body>
    ...
    <div>
        <table class="table-booked">
            ...
            <tr>
                <td class="td-text-book-border"><div><h3>10:00 - 12:00 น.</h3></div></td>
            </tr>
            <tr>
                <td class="td-text-book-bold"><label>ชื่อคนจอง :</label></td>.
            </tr>
            <tr>
                <td class="td-text-book-border"><div><h3>คุณพิทักษ์ ยอดศักร์</h3></div></td>
            </tr>
            <tr>
                <td></td>
                <td>
    ...
    <script>
        ...
        function confirmCancellation() {
            ...
            if (confirmCancel) {
                ...
                window.location.href = 'admin_ยกเลิก_เสร็จ_booking_room2_10-12.php';
            }
        }
    </script>   
</body>
