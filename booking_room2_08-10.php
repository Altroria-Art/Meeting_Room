...
<body>
    ...
    <table class="table-main">
        ...
        <tr>
            <td>CE02</td>
            <td colspan="2" class="me-booked" onclick="window.location.href='user_ยกเลิก_booking_room2_08-10.php'">คุณ<?php echo $row['firstname'] . ' ' . $row['lastname']; ?>  <br> 08:00 - 10:00 น.</td>
    ...
    <div class="booking-container">
        <button class="booking-button" type="submit" onclick="window.location.href='user_ยกเลิก_booking_room2_08-10.php'">ดูห้องที่คุณจอง</button>
    </div>
    </div>
</body>
</html>