...
<body>
    ...
    <table class="table-main">
        ...
        <tr>
            ...
            <td colspan="2" class="me-booked" onclick="window.location.href='user_ยกเลิก_booking_room1_10-12.php'">คุณ<?php echo $row['firstname'] . ' ' . $row['lastname']; ?>  <br> 10:00 - 12:00 น.</td>
            <td></td>
            <td></td>
    ...
    <div class="booking-container">
        <button class="booking-button" type="submit" onclick="window.location.href='user_ยกเลิก_booking_room1_10-12.php'">ดูห้องที่คุณจอง</button>
    </div>
    </div>
</body>
</html>