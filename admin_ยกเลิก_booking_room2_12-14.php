...
<body>
    ...
    <div>
        <table class="table-booked">
            ...
            <tr>
                <td class="td-text-book-border"><div><h3>CE02</h3></div></td>
            </tr>
            <tr>
                <td class="td-text-book-bold"><label>เวลาที่จอง :</label></td>.
            </tr>
            <tr>
                <td class="td-text-book-border"><div><h3>12:00 - 14:00 น.</h3></div></td>
            </tr>
            <tr>
                <td class="td-text-book-bold"><label>ชื่อคนจอง :</label></td>.
            </tr>
            <tr>
                <td class="td-text-book-border"><div><h3>คุณเกียรติศักต์ ว่าน้อย</h3></div></td>
            </tr>
            <tr>
                <td></td>
                <td>
    ...
    <script>
        ...
        function confirmCancellation() {
            ...
            if (confirmCancel) {
                ...
                window.location.href = 'admin_ยกเลิก_เสร็จ_booking_room2_12-14.php';
            }
        }
    </script>   
</body>
