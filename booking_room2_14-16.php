...
<body>
    ...
    <table class="table-main">
        ...
        <tr>
            ...
            <td colspan="2" class="me-booked" onclick="window.location.href='user_ยกเลิก_booking_room2_14-16.php'">คุณ<?php echo $row['firstname'] . ' ' . $row['lastname']; ?>  <br> 14:00 - 16:00 น.</td>
        </tr>
    </table>
    <!--ปุ่มดูห้องที่คนจอง-->
    <div class="booking-container">
        <button class="booking-button" type="submit" onclick="window.location.href='user_ยกเลิก_booking_room2_14-16.php'">ดูห้องที่คุณจอง</button>
    </div>
    </div>
</body>
</html>