...
<body>
    ...
    <div>
        <table class="table-booked">
            ...
            <tr>
                <td class="td-text-book-bold">ห้องที่ต้องการเลือก :</td>
            </tr>
            <tr>
                <td>
                <label for="room">เลือกห้องประชุม:</label>
                    <select id="room" onchange="updateTimeOptions()">
                        <option value="">-- กรุณาเลือกห้อง --</option>
                        <option value="room1">CE01</option>
                        <option value="room2">CE02</option>
                    </select>
                </td>
            </tr>
            <tr>
                <td>
                    <label for="time">เวลาที่สามารถจองได้:</label>
            ...
            <tr>
            <td class="td-text-book-border"><div><h3>คุณ<?php echo $row['firstname'] . ' ' . $row['lastname']; ?></h3></div></td>
            </tr>
            <tr>
                <td></td>
                <td>
                <button type="button" class="botton-green" onclick="redirectToBookingPage()">จองห้องประชุม</button>
                </td>
            </tr>
        </table>
    </div>
